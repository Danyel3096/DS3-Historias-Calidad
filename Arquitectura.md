...
| **US-02** | Como cliente de la aplicación quiero agregar productos al carrito de compras para realizar un pedido. | - El cliente puede agregar productos al carrito desde la página de detalles del producto.<br>- El carrito muestra un resumen de los productos agregados, incluyendo cantidad, precio unitario y total.
<br>- El cliente puede modificar la cantidad de productos en el carrito o eliminarlos.<br>- El carrito se mantiene persistente durante la sesión del cliente (incluso si cierra y vuelve a abrir la aplicación).                                                                                                                                                           
